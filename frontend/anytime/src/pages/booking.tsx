  ...
  return (
    <div className="min-h-screen bg-[#F6F8FB] flex flex-col">
      ...
      <section className="bg-white pt-6 pb-6 flex flex-col items-center px-4">
        ...
        <p className="text-sm md:text-lg text-gray-600 mb-4 text-center">
          Browse trusted providers and book instantly.
        </p>
        ...
        <div className="bg-white rounded-xl shadow-xl p-4 md:p-8 flex flex-col md:flex-row gap-4 md:gap-8 max-w-3xl w-full">
          ...
          <div className="flex flex-col items-start w-full md:w-[260px]">
            ...
            <div className="flex gap-2 mb-2 flex-wrap">
              <span className="flex items-center gap-1 px-2 py-1 bg-yellow-100 rounded text-xs md:text-sm font-semibold">
                <span>★</span> 4.1
              </span>
              <span className="flex items-center gap-1 px-2 py-1 bg-green-100 rounded text-xs md:text-sm font-semibold">
                <span>$</span> 10/hr
              </span>
            </div>

            <button className="bg-[#C7B2F9] text-white px-4 py-1 rounded-lg text-xs md:text-sm font-semibold mb-2 w-full md:w-auto">
              Send Inquiry
            </button>

            <p className="text-xs md:text-sm text-gray-700 mb-2 max-h-[5.2rem] overflow-hidden md:max-h-none md:overflow-visible">
              Hi, I’m Mary! 🐾 I’ve been walking and caring for dogs for over 5
              years, and I absolutely love spending time with them. Whether it’s
              a playful puppy or a senior dog who enjoys a slower stroll, I
              tailor each walk to your pet’s needs. I also make sure they get
              plenty of exercise, love, and treats along the way. Your dog’s
              safety and happiness are always my top priority!
            </p>
          </div>
          ...
          <div className="flex flex-col w-full md:w-[220px]">
            <div className="bg-[#F6F8FB] rounded-lg p-3 md:p-4 mb-2 max-h-40 md:max-h-48 overflow-auto">
              ...
              <div className="text-xs md:text-sm text-gray-700 mb-2">
                <span className="font-bold">Matthius:</span> 💜💜🤍 When the dog
                sitter walked me it was so awesome sauce
              </div>
              <div className="text-xs md:text-sm text-gray-700 mb-2">
                <span className="font-bold">Amogh:</span> 💜🤍🤍 She gave my
                obese dog 10 treats
              </div>
              <div className="text-xs md:text-sm text-gray-700 mb-2">
                <span className="font-bold">Michelle:</span> 💜💜💜 Mary is so
                sweet! She brought my dog some yummy treats :)
              </div>
              <div className="text-xs md:text-sm text-gray-700">
                <span className="font-bold">Alyssa:</span> 💜💜💜 Lovely
                Service.
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex flex-col gap-2 w-full md:w-1/2">
                ...
                <div className="flex gap-2">
                  <button className="px-3 py-1 rounded-full border border-gray-300 bg-[#F6F8FB] text-xs font-semibold">
                    Today
                  </button>
              ...
              <div className="flex flex-col gap-2 w-full md:w-1/2">
                ...
                <div className="flex gap-2 items-center flex-wrap">
                  <input
                    ...
                    min="1"
                    max="12"
                    className="w-16 px-2 py-1 rounded-full border border-gray-300 bg-[#F6F8FB] text-xs font-semibold"
                    placeholder="--"
                  />
                  ...
                  <div className="flex gap-2 ml-0 sm:ml-2 mt-2 sm:mt-0 w-full sm:w-auto">
                    <button className="px-3 py-1 rounded-full border border-gray-300 bg-[#F6F8FB] text-xs font-semibold w-full sm:w-auto">
                      AM
                    </button>
                    <button className="px-3 py-1 rounded-full border border-gray-300 bg-[#F6F8FB] text-xs font-semibold w-full sm:w-auto">
                      PM
            ...
            <form onSubmit={handleCardSubmit} className="flex flex-col gap-3">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center mt-2 gap-2">
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                  <button
                    type="button"
                    className="px-4 py-2 rounded border w-1/2 sm:w-auto"
                    onClick={() => setShowCardModal(false)}
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="px-4 py-2 rounded bg-[#6C38B8] text-white font-bold w-1/2 sm:w-auto"
                  >
                    Proceed
                  </button>
                </div>
            ...
            <div className="bg-white rounded-xl shadow flex flex-col md:flex-row items-center p-4 gap-4">
              <div className="flex flex-col flex-1">
                ...
                <div className="flex gap-2 mb-2">
                  <span className="flex items-center gap-1 px-2 py-1 bg-yellow-100 rounded text-xs font-semibold">
                    <span>★</span> 4.1
                  </span>
                  <span className="flex items-center gap-1 px-2 py-1 bg-green-100 rounded text-xs font-semibold">
                    <span>$</span> 5/h
                  </span>
                </div>
              </div>
              <div className="flex flex-col items-end gap-2 w-full md:w-auto">
                <span className="bg-pink-400 text-white text-xs font-bold px-3 py-1 rounded-full">
                  Off 55%
                </span>
                <button className="bg-[#6C38B8] text-white px-6 py-2 rounded-full font-bold text-xs flex items-center gap-2 w-full md:w-auto">
